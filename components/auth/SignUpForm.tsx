...
export function SignUpForm({ onSuccess, redirectTo = '/onboarding' }: SignUpFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Second Turn Games</h1>
        <p className="text-gray-600">Create your account to start trading board games</p>
      </div>
